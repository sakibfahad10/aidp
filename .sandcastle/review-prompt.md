...
3. Set the git identity so the commit is authored by the assigned team member, then commit describing the refinements:
   ...
   Set the commit date by prefixing the commit command with the date environment variables:
